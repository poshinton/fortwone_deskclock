...
public class DeskClock extends Activity {
    ...
    private static final String ACTION_MIDNIGHT = "com.fortwone.fortwone_deskclock.MIDNIGHT";
    ...
    public static class FontManager {  
        ...
        public static void changeFonts(ViewGroup root, Activity act) {  
           ...
           for (int i = 0; i < root.getChildCount(); i++) {  
               ...
               }  else if (v instanceof AndroidClockTextView){
            	   ((AndroidClockTextView) v).setTypeface(tf);
               }
           }  
